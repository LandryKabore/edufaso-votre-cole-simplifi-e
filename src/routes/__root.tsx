...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EduFaso — Système de gestion scolaire" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "EduFaso — Système de gestion scolaire" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,600;9..144,700;9..144,800&family=Manrope:wght@400;500;600;700&display=swap",
      },
    ],
  }),
